...
<body>
    <div class="container">
        ...
        if(isset($_POST["submit"])){
            ...
            if(empty($fullName) OR empty($email) OR empty($password) OR empty($re_enter_password)){
            ...
            if(count($errors)>0){
                ...
                //we will insert data in to database
             ...
             if ($preparestmt){
                mysqli_stmt_bind_param($stmt, "sss", $fullName, $passwordhash);
